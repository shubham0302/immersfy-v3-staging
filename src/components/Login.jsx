    ...
    >
      <Box width={400} textAlign="center">
        <img
          src={logo}
          alt="Logo"
          style={{ width: "100px", marginBottom: "12px", filter: "invert(1)" }}
        />
        <Typography
          variant="body1"
          sx={{
        ...
        <Button
          ...
          startIcon={
            <img src={GoogleIcon} alt="Logo" style={{ width: "16px" }} />
          }
        >
          Sign in with google
        </Button>
        ...
        <Box sx={{ marginBottom: "16px" }}>
          ...
          />
          <FormHelperText sx={{ color: "error.dark" }}>
            {emailError}
          </FormHelperText>
        </Box>
        ...
        >
          ...
          <span style={{ color: "#201612" }}>Terms</span> and{" "}
          <span style={{ color: "#201612" }}>Privacy Policy</span>
        </Typography>
        ...
        >
          No Immersify account? <a style={{ color: "#FF3C00" }}> Sign up </a>
        </Typography>
      </Box>
    </Box>
  );
